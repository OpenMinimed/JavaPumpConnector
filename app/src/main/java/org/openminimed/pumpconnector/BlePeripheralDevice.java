...
public class BlePeripheralDevice {
    ...
    // Custom UUIDs
    private static final UUID DEVICE_INFO_SERVICE_UUID =
        UUID.fromString("00000900-0000-1000-0000-009132591325");
    private static final UUID SAKE_SERVICE_UUID =
        UUID.fromString("0000fe82-0000-1000-8000-00805f9b34fb");
    private static final UUID SAKE_CHARACTERISTIC_UUID =
        UUID.fromString("0000fe82-0000-1000-0000-009132591325");
    ...
    private static final UUID SOFTWARE_REVISION_UUID =
        UUID.fromString("00002a28-0000-1000-8000-00805f9b34fb");
    private static final UUID SYSTEM_ID_UUID =
    ...
    private static final UUID REGULATORY_CERT_UUID =
    ...
    public static String MOBILE_NAME = "Mobile 000001";
    ...
    public String changeMobileName(String name) {


        if (!name.isBlank()) { // Check if the text is not blank

            name = "Mobile " + (name + "       ").substring(0, 7); // if not blank, add 7 space and resize to 7 to make sure there is 7 character in total
            MOBILE_NAME = name; // Change the Mobile name for the pump to the name indicated

            Log.e("ChangeMobileName", "Mobile name changed to : " + MOBILE_NAME);
        }

        else {
            Log.e("ChangeMobileName", "Did not changed mobile name because the name was blank");
        }
